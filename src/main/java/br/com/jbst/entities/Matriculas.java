...
public class Matriculas {
	...
	@ManyToMany
	@JoinTable(name = "usuarios_matricula", joinColumns = @JoinColumn(name = "id_matricula"), inverseJoinColumns = @JoinColumn(name = "id_usuario"))
	private List<Usuario> usuarios;

	@OneToMany(mappedBy = "matricula", cascade = CascadeType.ALL, orphanRemoval = true)
	private List<ResultadoAvaliacaoAluno> resultados;

	@OneToMany(mappedBy = "matricula") // 'matricula' deve corresponder ao nome do campo em ProgressoAlunoTopico
    private List<ProgressoAlunoTopico> progressoAlunoTopico;
